...
const Projects = (props: Props) => {
  ...
  xl:px-2 h-screen justify-evenly overflow-x-scroll overflow-y-hidden z-10  mx-auto items-center space-y-10 xl:space-y-20
   ...
   >
      ...
      <div className="w-full relative flex overflow-x-scroll items-center justify-center overflow-y-hidden snap-x snap-mandatory z-10">
        {projects.map((project, i) => (
          ...
          md:p-44 h-screen"
          >
            <img src={logo.src} alt="img" className="drop-shadow-xl border xl:w-[400px]" />
